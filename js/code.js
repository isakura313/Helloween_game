...
const instructions = [
    "Перед вами игра Halloween JavaScript, изучите внимательно инструкцию. Эта игра может выполнить любую JS команду, здесь есть некоторая свобода. Постарайтесь выполнить инструкциии выполните как можно больше квестов. Для начала выполните alert с любым сообщением)",
    ...
    "Теперь вам нужно написать код, который назначит каждой двери в виде последнего предка Монстрика из массива monsters_on_doors.  Используйте insertAdjacentElement",
    "Теперь вам нужно на тыковке повесить обработчик, чтобы при клике на элемент с классом pumkin раздавался зловей смех witch.mp3",
